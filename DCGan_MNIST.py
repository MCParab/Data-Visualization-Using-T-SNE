...
generator.add(128*7*7, input_dim = randomDim, kernel_initializer = initializers.RandomNormal(stdev = 0.02)))
...
discriminator.add(Conv2D(64, kernel_size=(5, 5), strides=(2, 2), padding = 'same', input_shape=(1, 28,28), kernel_initializer = initializers.RandomNormal(stdev = 0.02)))
